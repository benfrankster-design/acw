...
Archived entries from `decisions/decision-log.md`. Earned by the bi-weekly rolling-window discipline declared in `rules/decision-tracking.md` and applied via the `decision-log.md` caveat in `rules/auto-load-discipline.md`. These entries are historical reference material; current decisions live in the inline file.

Coverage: entries dated **2026-04-30 through 2026-05-02** (D-001 through D-005, D-ACW-006 through D-ACW-034). Source rotated 2026-05-05 in v0.9.1.
